...
# Task description
In this predict you will be tasked to build and deploy a ML model for the government of Spain to predict the shortfall between energy generated by fossil fuels and energy generated with renewable sources, and to participate in a Kaggle challenge.
